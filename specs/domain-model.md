...
| AgentConversation | conversation_id, owner_id, semantic_context, turn_count, last_seen_at, expires_at | owner-scoped, TTL-bounded routing metadata only; no raw transcript or environmental values |
