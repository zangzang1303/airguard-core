...
[![Tests](https://img.shields.io/badge/Tests-153%2F153%20Passed%20(100%25)-10B981.svg?style=flat)](../testing/)
...
>   * 📐 [**Sơ đồ & Tài liệu Kiến trúc (Architecture)**](../architecture/) — Sơ đồ C4, 5 phân tầng, IoT Telemetry, HITL Dispatcher.
>   * 🎨 [**Đặc tả SRS & Thiết kế UI/UX (Design)**](../design/SRS.md) — Đặc tả IEEE 830 v2.2.0, 10 Use Cases, 2 Roles, Live UI Mockups.
>   * 🧪 [**Kế hoạch & Báo cáo Kiểm thử (Testing)**](../testing/) — Test Plan, 153/153 Automated Test Cases Passed (100%).
